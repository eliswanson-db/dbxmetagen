...
model_input = [
    ...
    {"role": "user", "content": "Content is here and abbreviations are here."},
]
...
chat_response_dict = (
    chat_response.__dict__ if hasattr(chat_response, "__dict__") else chat_response
)
...
with mlflow.start_run():
    ...
    ### Want to add mlflow.evaluate here
...
loaded = mlflow.pyfunc.load_model(f"models:/{full_model_name}/{latest_model_version}")
