...
show_app_info() {
    ...
    echo ""
    echo "📚 Next steps:"
    echo "   1. Update serverless_warehouse_id in variables.yml with your warehouse ID"
    echo "   2. Run the permissions setup job (dbxmetagen_permissions_setup) to grant catalog access"
    echo "   3. Configure your catalog and host settings in the app"
    echo "   4. Upload a table_names.csv or manually enter table names"
    echo "   5. Create and run metadata generation jobs"
    echo "   6. Review generated metadata and download results"
    echo ""
